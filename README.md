...
$$
\\\\ =  L * I * \sum_{i=1}^{10} \sum_{j=1}^{10} \sum_{k=1}^{10}[( T_{1,i}  *  T_{2,j}  *  T_{3,k} ) * x_{i,j,k}] -\frac {L*(I+1)}{3} * \sum_{i=1}^{10} \sum_{j=1}^{10} \sum_{k=1}^{10}[(H_{1,i} + H_{2,j} + H_{3,k}) * T_{1,i}  *  T_{2,j}  *  T_{3,k} * x_{i,j,k}^2]
$$
...
$$P =\prod_{(i,j) \in \mathcal{X}}(x_{i,j}*T_{i,j} +1-x_{i,j})  = \prod_{(i,j) \in \mathcal{X}}(T_{i,j}^{x_{i,j}})  \\\\Q = \frac{1}{3} * \sum_{(i,j) \in \mathcal{X} }( H_{i,j} * x_{i,j})$$
...
$$
H = \sum_{{(i, j,k,l, m,n) \in \mathcal{X}}} H_{i,j,k,l,m,n} \\\\ = \sum_{i=1}^{100} \sum_{j=1}^{100} \sum_{k=1}^{100} \sum_{l=1}^{10} \sum_{m=1}^{10} \sum_{n=1}^{10} [{L * I * P_{i,j,k,l,m,n} * (1-Q_{i,j,k,l,m,n}) - L * P_{i,j,k,l,m,n} * Q_{i,j,k,l,m,n} }]
$$
